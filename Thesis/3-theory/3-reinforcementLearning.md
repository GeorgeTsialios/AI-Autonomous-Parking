...
#### Η τεχνική $\varepsilon$-greedy

Ένα σημαντικό κομμάτι της παραπάνω διαδικασίας είναι το πως ο πράκτορας επιλέγει την ενέργεια που θα εκτελέσει σε κάθε κατάσταση, όταν βρίσκεται ακόμα στο στάδιο της εκπαίδευσης. Πρόκειται για το δίλημμα εξερεύνησης-αξιοποίησης, το οποίο αναλύθηκε στην παράγραφο @sec:theory:reinforcement_learning:concepts. Ο αλγόριθμος $Q$-Learning αντιμετωπίζει το πρόβλημα αυτό, χρησιμοποιώντας την τεχνική $\varepsilon$-greedy. 
...
Η μεθοδολογία του αλγορίθμου $Q$-Learning δίνεται υπό μορφή ψευδοκώδικα (*pseudocode*) στον 
...
![Το παιχνίδι Frozen Lake της βιβλιοθήκης OpenAI Gymnasium.](3-theory/figures/FrozenLake.png){#fig:theory:reinforcement_learning:frozen_lake width=70%}
...
![Αποτελέσματα εκπαίδευσης στο παιχνίδι Frozen Lake.](3-theory/figures/Q-Table-FrozenLake.png){#fig:theory:reinforcement_learning:frozen_lake_results width=70%}
