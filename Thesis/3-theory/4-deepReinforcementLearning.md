...
- Η συνάρτηση $\min$ χρησιμοποιείται για την επιλογή του ελάχιστου μεταξύ της μη-περικομμένης και περικομμένης αντικειμενικής συνάρτησης. Έτσι, η τελική αντικειμενική συνάρτηση είναι ένα κάτω φράγμα (δηλαδή μια απαισιόδοξη εκτίμηση) της μη-περικομμένης αντικειμενικής συνάρτησης.
