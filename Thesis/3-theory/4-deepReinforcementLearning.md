...
- Έξοδος Δικτύου: η έξοδος του νευρωνικού δικτύου αποτελείται από τις τιμές Q για όλες τις διαθέσιμες ενέργειες στην τρέχουσα κατάσταση του περιβάλλοντος. Η επιλογή ενέργειας γίνεται με βάση κάποια τεχνική όπως η $\epsilon$-greedy, για την αντιμέτωπιση του διλήμματος εξερεύνησης-αξιοποίησης, όπως έχει αναφερθεί στην υποενότητα {@sec:theory:reinforcement_learning:q_learning}.
