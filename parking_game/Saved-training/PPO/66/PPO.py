    ...
    def step(self, action):
       ...
       # [radar0, radar1, radar2, radar3, radar4, radar5, radar6, radar7, offset_x, offset_y, velocity, angle]
        ...
        #         reward += 5
            ...
            reward -= abs(state[8]) * 10     # punish the car for being far from the parking spot in the x direction
            reward -= abs(state[9]) * 10     # punish the car for being far from the parking spot in the y direction
...
if __name__ == '__main__':
    ...
    train_PPO(20000000, render=False, steps_previously_trained=0, run='66B')
    # test_PPO(100, run='65B', steps_trained=14250000, render=False)
