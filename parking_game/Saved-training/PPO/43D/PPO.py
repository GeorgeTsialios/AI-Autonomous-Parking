    ...
    def step(self, action):
       ...
       # [radar0, radar1, radar2, radar3, radar4, radar5, radar6, radar7, offset_x, offset_y, velocity, angle]
        ...
        if terminated:
            ...
            reward += 5 + 10 / (abs(state[10]) + 1)                      # reward for being inside the parking spot
...
if __name__ == '__main__':
    ...
    # train_PPO(7000000, render=False, steps_previously_trained=0, run='43D')
    test_PPO(10, run='43D', steps_trained=3100000, render=True)