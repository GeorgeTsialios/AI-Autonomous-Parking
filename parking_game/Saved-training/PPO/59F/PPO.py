    ...
    def step(self, action):
       ...
       # [radar0, radar1, radar2, radar3, radar4, radar5, radar6, radar7, offset_x, offset_y, velocity, angle]
        ...
        if self.current_step >= self.max_steps:
            ...
            terminated = True
            info['truncated'] = True
        elif self.num_collisions >= 1:              # Early stopping
            reward -= 40
            info["is_success"] = False
            truncated = True
            terminated = True
...
if __name__ == '__main__':
    ...
    # train_PPO(20000000, render=False, steps_previously_trained=1, run='59F')
    test_PPO(1000, run="59F", steps_trained=6300000, render=True)
