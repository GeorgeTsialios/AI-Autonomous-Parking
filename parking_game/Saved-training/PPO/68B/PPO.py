    ...
    def step(self, action):
       ...
       # [radar0, radar1, radar2, radar3, radar4, radar5, radar6, radar7, offset_x, offset_y, velocity, angle]
        ...
        if terminated:
            ...
            reward +=  100 / (abs(state[10]) + 1)                      # reward for being inside the parking spot
...
if __name__ == '__main__':
    ...
    # train_PPO(250000000, render=False, steps_previously_trained=1, run='68B')
    test_PPO(100, run='68B', steps_trained=6300000, render=True)
