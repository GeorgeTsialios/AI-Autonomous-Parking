    ...
    def step(self, action):
       ...
       # [radar0, radar1, radar2, radar3, radar4, radar5, radar6, radar7, offset_x, offset_y, velocity, angle]
        ...
        if terminated:
            ...
            reward += 6 / (abs(state[8]) + 1)         
            reward += 6 / (abs(state[9]) + 1)
...
if __name__ == '__main__':
    ...
    # train_PPO(7000000, render=False, steps_previously_trained=0, run=51)
    test_PPO(10, run=51, steps_trained=3800000, render=True)
