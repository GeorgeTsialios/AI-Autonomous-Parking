...
class AbstractCar:
    ...
    def discretize_state(self):
        ...
        discrete_vel = round(self.vel / 4, 2)      
        ...
        offset_y = round((self.center[1] - free_spot_rect.centery) / 478.5, 2)
...
if __name__ == '__main__':
    ...
    train_PPO(7000000, render=False, steps_previously_trained=7000000, run='53B')
    # test_PPO(1000, run='53A', steps_trained=4000000, render=True)pip install --upgrade tensorboard tensorflow
