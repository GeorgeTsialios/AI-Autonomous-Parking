    ...
    def step(self, action):
       ...
       # [radar0, radar1, radar2, radar3, radar4, radar5, radar6, radar7, offset_x, offset_y, velocity, angle]
        ...
        if terminated:
            ...
            if collides:
                # print("COLLIDING", end=" ")
                reward -= 15             # punish the car for colliding with an object
...
if __name__ == '__main__':
    ...
    # train_PPO(7000000, render=False, steps_previously_trained=3150000, run='43E')
    test_PPO(10, run='43E', steps_trained=4550000, render=True)