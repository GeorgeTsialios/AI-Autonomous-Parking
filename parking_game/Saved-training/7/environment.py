...
def train_q(total_episodes, render=False, episodes_previously_trained=0, checkpoint=-1):
    ...
    max_epsilon = 1.0
    min_epsilon = 0.0001
    decay_rate = 0.008  # the higher the decay rate, the faster the epsilon will decrease and the agent will start to exploit more than explore
...
if __name__ == '__main__':
    ...
    train_q(12000, render=False, episodes_previously_trained=0, checkpoint=1000000)
