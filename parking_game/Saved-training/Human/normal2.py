...
register(
    id='parking-game-v0',                          
    entry_point='normal2:ParkingGameEnv', # module_name:class_name
)
...
DARKBLUE_CAR = [scale_image(pygame.image.load("parking_game/imgs/car-red-wheels.png"), 40/161), scale_image(pygame.image.load("parking_game/imgs/car-red-wheels-right.png"), 40/161)]            # factor is equal to desired width of car / actual width of image
...
class ParkingGameEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        self.steps_list = []            # number of steps for each successful parking        self.collisions_list = []       # number of collisions for each successful parking
