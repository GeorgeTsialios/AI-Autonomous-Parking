...
def train_TD3(steps_to_train, render=False, steps_previously_trained=0, run=1):
    ...
    model.learn(total_timesteps=steps_to_train, callback=checkpoint_callback, tb_log_name="TD3", reset_num_timesteps=steps_previously_trained<=1)  # Train the model
...
if __name__ == '__main__':
    ...
    # train_TD3(10000000, render=False, steps_previously_trained=1, run="15F")
    test_TD3(100, run="15F", steps_trained=1000000, render=False)
