       ...
       # [radar0, radar1, radar2, radar3, radar4, radar5, radar6, radar7, offset_x, offset_y, velocity, angle]
        ...
        if terminated:
            ...
            if state[10] >= 0.4:                                               # extra reward for parking moving forward
                reward += 50 / (abs(state[10] - 0.4) + 1)                      # reward for being inside the parking spot
            else:
                reward += 30 / (abs(state[10] - 0.4) + 1)
            ...
            if collides:
                # print("COLLIDING", end=" ")
                reward -= 500             # punish the car for colliding with an object
