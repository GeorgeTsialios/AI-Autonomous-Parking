...
class ParkingGameEnv(gym.Env):
    ...
    def initialize_game(car_spawn_index):
        ...
        free_spot_index =  random.randint(6, 10) if car_spawn_index == 1 else random.randint(1, 5)  # 8 if car_spawn_index == 1 else 3    # the free spot will be on the same side of the player car
...
if __name__ == '__main__':
    ...
    # train_TD3(7000000, render=False, steps_previously_trained=0, run=5)
    test_TD3(1000, run=5, steps_trained=4050000, render=True)
