    ...
    def step(self, action):
       ...
       # [radar0, radar1, radar2, radar3, radar4, radar5, radar6, radar7, offset_x, offset_y, velocity, angle]
        ...
        #         reward += 5
            ...
            if state[10] > 0.55 or state[10] < 0.25:
                reward += 2
...
if __name__ == '__main__':
    ...
    # train_TD3(7000000, render=False, steps_previously_trained=600000, run='Simple')
    test_TD3(1000, run='Simple', steps_trained=1850000, render=True)