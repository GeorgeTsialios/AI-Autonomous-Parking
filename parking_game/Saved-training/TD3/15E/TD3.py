...
def test_TD3(test_episodes, run=1, steps_trained=0, render=True):
    ...
    episode_list = [50, 64, 86, 97]
    for episode in range(0, test_episodes+1):
        terminated = False
        truncated = False
        total_reward = 0
        state = env.reset(seed=episode_list[episode])[0]
...
if __name__ == '__main__':
    ...
    # train_TD3(10000000, render=False, steps_previously_trained=1, run="15E")
    test_TD3(4, run="15E", steps_trained=1000000, render=True)
