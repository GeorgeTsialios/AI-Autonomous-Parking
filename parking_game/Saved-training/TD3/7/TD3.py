...
class ParkingGameEnv(gym.Env):
    ...
    def initialize_game(car_spawn_index):
        ...
        free_spot_index = random.randint(1, 5) if car_spawn_index == 0 else random.randint(6,10) if car_spawn_index == 1 else random.randint(1, 10)      # the free spot will be randomly chosen at the beginning of each game
...
if __name__ == '__main__':
    ...
    # train_TD3(7000000, render=False, steps_previously_trained=0, run=7)
    test_TD3(1000, run=7, steps_trained=3050000, render=True)
