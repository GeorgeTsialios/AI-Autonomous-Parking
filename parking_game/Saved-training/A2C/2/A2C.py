...
def train_A2C(steps_to_train, render=False, steps_previously_trained=0, run=1):
    ...
    if steps_previously_trained > 0:
        ...
        model = A2C("MlpPolicy", env, verbose=1, tensorboard_log=log_dir,learning_rate=0.00007, device="cpu")       # Create A2C model, MlpPolicy is a 2-layer neural network with 64 units each
...
if __name__ == '__main__':
    ...
    train_A2C(5000000, render=False, steps_previously_trained=0, run=2)
