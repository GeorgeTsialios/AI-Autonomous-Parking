...
def train_q(total_episodes, render=False, episodes_previously_trained=0, checkpoint=-1):
            ...
            for event in pygame.event.get():            
                if event.type == pygame.QUIT:       # If the user closes the window, the game stops
                    if episode > 100:
                        ...
                        print_stats(start_time, epsilon, episode_rewards, episode_successes, episode)
    ...
    print_stats(start_time, epsilon, episode_rewards, episode_successes, total_episodes) 
...
def print_stats(start_time, epsilon, episode_rewards, episode_successes, episodes_currently_trained, episodes_previously_trained=0):
...
if __name__ == '__main__':
    ...
    # train_q(20000, render=False, episodes_previously_trained=6000, checkpoint=-2)
    test_q(10, 20000, render=True)