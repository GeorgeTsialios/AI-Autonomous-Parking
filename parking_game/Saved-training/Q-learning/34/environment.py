...
class AgentCar(AbstractCar):
    ...
    def move_player(self, agent_action):
        ...
        if agent_action == AgentAction.UP_LEFT or agent_action == AgentAction.UP_RIGHT:
            throttling = True
            self.move_forward()
        elif agent_action == AgentAction.DOWN_LEFT or agent_action == AgentAction.DOWN_RIGHT:
            throttling = True
            self.move_backward()
...
if __name__ == '__main__':
    ...
    test_q(1000, 15000, render=False)