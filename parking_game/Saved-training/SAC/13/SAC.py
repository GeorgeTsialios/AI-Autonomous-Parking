       ...
       # [radar0, radar1, radar2, radar3, radar4, radar5, radar6, radar7, offset_x, offset_y, velocity, angle]
        ...
        if terminated:
            ...
            if collides:
                # print("COLLIDING", end=" ")
                self.collisions += 1
                reward -= 1300             # punish the car for colliding with an object
...
if __name__ == '__main__':
    ...
    # train_SAC(27000000, render=False, steps_previously_trained=1, run='13B')
    test_SAC(100, run='13B', steps_trained=6400000, render=False)
