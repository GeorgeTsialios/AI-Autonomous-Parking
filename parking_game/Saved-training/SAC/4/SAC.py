...
def test_SAC(test_episodes, run=1, steps_trained=0, render=True):
    ...
    for episode in range(8, test_episodes+1):
        terminated = False
        truncated = False
        total_reward = 0
...
if __name__ == '__main__':
    ...
    # train_SAC(7000000, render=False, steps_previously_trained=0, run=4)
    test_SAC(1000, run=4, steps_trained=6700000, render=True)
