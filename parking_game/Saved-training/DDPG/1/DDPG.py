...
def train_DDPG(steps_to_train, render=False, steps_previously_trained=0, run=1):
    ...
    model.learn(total_timesteps=steps_to_train, callback=checkpoint_callback, tb_log_name="DDPG", reset_num_timesteps=steps_previously_trained<=0)  # Train the model
...
if __name__ == '__main__':
    ...
    # train_DDPG(27000000, render=False, steps_previously_trained=0, run=1)
    test_DDPG(100, run=1, steps_trained=3250000, render=True)
